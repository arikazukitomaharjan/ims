...
@section('content')
    <ol class="breadcrumb">
        ...
        <li><a href="{{('category')}}">catogories</a></li>
    </ol>

    <div class="row" data-ng-controller="CategoryCtrl" data-ng-init="init()" st-table="displayedCollection"
         st-safe-src="categories">
        <div class="col-md-12">
            <div class="main-block">
                <div class="panel panel-default">
                    <div class="panel-heading">

                        <h3 class="panel-title">Category<span style="float:right;"><a href="#"
                                                                                      title="Add New"
                                                                                      data-toggle="modal"
                    ...
                    <div class="panel-body" style="padding: 25px">
                        <div class="table-responsive">
                            <table class="table table-hover" id="bootstrap-table">
                                ...
                                <tr data-ng-repeat="row in displayedCollection track by row.id">
                                    ...
                                    <td>
                                        ...
                                        <a href="#" data-ng-click="popup(row.id,row.name,row.description)"
                                           class="btn btn-primary btn-xs"
                                           data-target="#editCategory">Edit<span
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form name="forms" class="form-validation form-inline">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="description"
                                                   data-ng-model="input.description"
                                ...
                                <div class="modal-footer">
                                    <button class="btn btn-info" ng-disabled="forms.$invalid"
                                            data-ng-click="addCategory(input)">
                                        Add
                                    </button>
